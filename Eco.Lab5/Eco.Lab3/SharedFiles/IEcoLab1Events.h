...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events */
    int16_t(ECOCALLMETHOD* OnTreePrintCallback)(/* in */ struct IEcoLab1Events* me, /* in */ struct RBNode* p_Root, /* in */ int16_t bClear);
    int16_t(ECOCALLMETHOD* OnTreePrintWithHighlightCallback)(/* in */ struct IEcoLab1Events* me,
                                                             /* in */ struct RBNode* p_Root,
                                                             /* in */ struct RBNode* p_Highlight,
                                                             /* in */ int16_t bSecondaryColor,
                                                             /* in */ void* p_Element);
    int16_t(ECOCALLMETHOD* OnSaveCursorPositionCallback)(/* in */ struct IEcoLab1Events* me);
    int16_t(ECOCALLMETHOD* OnTreeInorderTraversalCallback)(/* in */ struct IEcoLab1Events* me, /* in */ struct RBNode* p_Root);
