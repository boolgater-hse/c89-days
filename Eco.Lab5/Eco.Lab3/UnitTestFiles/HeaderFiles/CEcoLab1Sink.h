...
typedef struct CEcoLab1Sink {
    ...
    int16_t(ECOCALLMETHOD* SetPrintFunction)(/* in */ struct CEcoLab1Sink* me, /* in */ void(ECOCDECLMETHOD* fnPrinter)(const void*));

    void (ECOCDECLMETHOD* m_fnPrinter)(const void*);
